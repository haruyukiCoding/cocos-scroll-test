  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", main = (_dec = ccclass('main'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(ScrollView), _dec(_class = (_class2 = class main extends Component {
        ...
        // 头像图列表
        async onLoad() {
          this.startPos = v2(this.viewContent.position.x, this.viewContent.position.y); // this.visibleHeight = this.maskNode.getContentSize().height;
...
//# sourceMappingURL=3c35a2c8ed63ac623d9b85587c6f5078336e4eb8.js.map