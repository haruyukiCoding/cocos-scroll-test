System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, item3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, TestItemCreate;
      ...
      _export("TestItemCreate", TestItemCreate = (_dec = ccclass('TestItemCreate'), _dec2 = property(Node), _dec3 = property(_crd && item3 === void 0 ? (_reportPossibleCrUseOfitem({
        ...
        start() {
          ...
          this.itemDataArray.forEach(element => {
            var ins = instantiate(this.itemPrefab);
            ins.setValue(element.itemName, element.itemDesc);
            this.contentNode.addChild(ins.node);
          });
        }
...
//# sourceMappingURL=294da19f9db221bd74a2d0124802d386e34d8ada.js.map