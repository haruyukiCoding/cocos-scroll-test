System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, main;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", main = (_dec = property(cc.Node), _dec2 = property(cc.Node), _dec3 = property(cc.ScrollView), ccclass(_class = (_class2 = class main extends cc.Component {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            _this.startPos = cc.v2(_this.viewContent.position.x, _this.viewContent.position.y);
            _this.visibleHeight = _this.maskNode.getContentSize().height;
        ...
        onRefresh(obj, idx, objIdx) {
          var head = obj.getChildByName("head").getComponent(cc.Sprite);
          var num = obj.getChildByName("num").getComponent(cc.Label);
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "maskNode", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "scroll", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=963a41fff050d44a32e34cb0ac55808c52a34fe9.js.map