      ...
      _export("default", main = (_dec = ccclass('main'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(ScrollView), _dec(_class = (_class2 = class main extends Component {
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.visibleHeight = _this.maskNode.getComponent(UITransform).height;
        ...
        loadList() {
          ...
          this.viewContent.getComponent(UITransform).setContentSize(new Size(this.viewContent.getComponent(UITransform).width, this.needSize));
        } // 初始化几个
...
//# sourceMappingURL=23542edf4cc22ea27a2c33aa038431ebac895cba.js.map